...
constexpr uint8_t CH_INPUT_PINS[PROJECT_CHANNEL_COUNT]  = { D0, D1, D2, D3 };
constexpr uint8_t CH_OUTPUT_PINS[PROJECT_CHANNEL_COUNT] = { D4, D5, D6, D7 };

// Device pin configuration
constexpr uint8_t VACUUM_OUTPUT_PIN = D8;
